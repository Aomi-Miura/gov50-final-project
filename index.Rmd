...
```
  Finally,the following regression uses "national interest index" as an additional predictor variable. The national interest index indicates how high the US has national security the US has vis-a-vis interventions. The index is an additive index measured by contiguity between the US and state B, whether the state B is or was the US colony or not, whether the US is allied with State B or not, and whether state B has a significant amount of oil in its territory. The index is measured by experts.
