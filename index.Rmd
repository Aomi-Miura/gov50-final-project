...
Furthermore, it is plausible that more hostile actions, such as the use of force, will prolong interventions more thanthe less hostile actions such as display of force. Thus, the relationship between the level of hostility and the length of intervention can be interpreted causally, even if there may be other confounding factors that affect both the outcome and explanatory variables.
